...
/*[1]
 * Descrizione:Inizializza la pcbFree in modo da contenere tutti 
 * gli elementi della pcb_table. Questo metodo deve essere chiamato una volta sola
...
/*[2]
 * Descrizione: Inserisce il pcb puntato da p nella lista dei pcbFree
*/
...
/*[3]
 * Descrizione: Restituisce NULL se la pcbFree e vuota.
